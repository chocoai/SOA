...
public class ZhucTestSoaOrderService {
    ...
    private String sellerBizUserId = "zxccy";
...
//    private String jjBankCardNo = "6214855740989666";
    	private String jjBankCardNo = "6228488887777777777";
    //行业代码
...
//			gatewayPay.put("bankCode", "vbank");  //虚拟银行，专门用于测试环境
            ...
            //posPay.put("bankCardNo", rsaEncrypt("6228488887778888888"));
            posPay.put("amount", amount);
            //组装支付方式
...
//			String bizOrderNo = "1460427411123cz";
    ...
    public void testApplyWithdraw() {
        try{
            ...
            param.put("backUrl", backUrl);
            param.put("ordErexpireDatetime", ordErexpireDatetime);
            param.put("bankCardNo", rsaEncrypt("6228491234567890127 "));
            param.put("industryCode", industryCode);
            param.put("industryName", industryName);
            param.put("source", source);
    ...
    public void testApplyDeposit2() {
        try{
            ...
            JSONObject gatewayPay = new JSONObject();
//			gatewayPay.put("bankCode", "vbank");  //虚拟银行，专门用于测试环境
            gatewayPay.put("bankCode", "icbc");  //生产环境
            gatewayPay.put("payType", 4L);
//			gatewayPay.put("bankCardNo", rsaEncrypt(jjBankCardNo));
...
//			param.put("ordErexpireDatetime", ordErexpireDatetime);
    ...
    public void testApplyConsume() {
        try{
            ...
            accountObject1.put("amount", amount);
...
//			gatewayPay.put("payType", 1L);
//			gatewayPay.put("amount", 1);1
//
            String frontUrl = "http://122.227.225.142:23661/gateway/getPayFront.jsp";
            JSONObject gatewayPay = new JSONObject();
            gatewayPay.put("bankCode", "vbank");  //虚拟银行，专门用于测试环境
            //gatewayPay.put("bankCode", "abc");  //招商银行，生产环境
            gatewayPay.put("payType", 28L);
            //gatewayPay.put("bankCardNo", rsaEncrypt(jjBankCardNo));
            gatewayPay.put("amount", amount);
...
//			payMethod.put("BALANCE", accountPay);
            ...
            JSONObject param = new JSONObject();
//			param.put("bizOrderNo", "1460977075368ds");
            param.put("bizOrderNo", bizOrderNo);
            param.put("payerId", bizUserId);
            param.put("recieverList", recieverList);
            param.put("goodsType", 1L);
            param.put("goodsNo", "1455676025600splr");
    ...
    public void testApplyHostPay() {
        try{
            ...
            collectPay1.put("bizOrderNo", "1462274598082ds");
            collectPay1.put("amount", 8L);
...
//			splitRuleList.put(splistRule1);
            ...
            String backUrl = "http://10.55.3.236:6003/test/recievePayBack.jsp";
            payToBankCardInfo.put("bankCardNo", rsaEncrypt("6228480318051081808"));
            payToBankCardInfo.put("amount", 8);
...
//
    ...
    public void testPay() {
        try{
            ...
            JSONObject param = new JSONObject();
            param.put("bizUserId", bizUserId);
            param.put("bizOrderNo", "1464331416248tx");
//			param.put("tradeNo", "1605091164635765D1");
            param.put("verificationCode", "191120");
