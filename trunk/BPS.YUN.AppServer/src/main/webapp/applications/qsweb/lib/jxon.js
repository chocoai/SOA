var JXON = new (function () {
  var
    ...
    xNameProp = "x_name", sValProp = "x_value", sAttrProp = "x_attributes", sAttrsPref = "",
  ...
  function createObjTree (oParentNode, nVerb, bFreeze, bNesteAttr) {
    ...
    var
      ...
      bAttributes = oParentNode.hasAttributes ? oParentNode.hasAttributes() : false, bHighVerb = Boolean(nVerb & 2);
	...
	vResult[xNameProp] = oParentNode.nodeName;
	vResult.children = children;
    return vResult;
  ...
  this.build = function (oXMLParent, nVerbosity /* optional */, bFreeze /* optional */, bNesteAttributes /* optional */) {
    ...
    var obj = createObjTree(oXMLParent, nVerbMask, bFreeze || false, arguments.length > 3 ? bNesteAttributes : nVerbMask === 3);
    obj.jpath = jpath;
    return obj;
  };
  ...
  function jpath(str){
	  var path = $.JSONPath({data: this});
	  return path.query(str);
  };
